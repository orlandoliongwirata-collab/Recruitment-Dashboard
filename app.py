...
try:
    ...
    # Menata tampilan tabel agar lebih profesional
    ...
    st.dataframe(
        df_display.style.format({'Target': '{:,.0f}', 'Realisasi': '{:,.0f}', '% Achievement': '{:.1f}%', 'Skor Nilai': '{:.2f}'})
        .background_gradient(subset=['% Achievement'], cmap='RdPu'),
    ...
    st.error(f"Error memuat detail: {e}")
